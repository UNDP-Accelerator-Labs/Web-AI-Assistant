...
def parse (file, **kwargs):
	...
	download_dir = join(getcwd(), 'docx_downloads/')
...
if __name__ == '__main__':
	...
	# file = '/Users/myjyby/Documents/Projects/Teams/scraper/files/Découvrez la caravane qui parcourt le Congo à la recherche de solutions innovantes.docx'
	print(parse(file))